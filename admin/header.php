    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">Outlet Nisa</a>
        </div>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li>
							<a href="tampil-pesanan.php"><span class="glyphicon glyphicon-user"></span>Data Pesanan</a>
						</li>
            <li>
							<a href="tampil-komentar.php"><span class="glyphicon glyphicon-info-sign"></span>Kritik dan Saran</a>
						</li>
            <li>

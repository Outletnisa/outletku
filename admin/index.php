				  ...
				  <div class="carousel" id="contoh-carousel" data-ride="carousel">
						...
						<div class="carousel-inner" role="listbox">
							<div class="item active">
								<img src="../produk/banner.jpg" alt="Keterangan Gambar satu">
								<div class="carousel-caption">
								<h1>SELAMAT DATANG ( <?php echo $_SESSION['username'];?> )</h1>
									<h2>Ini Adalah Halaman Website Khusus Admin</h2>
									<p><a class="btn btn-danger btn-lg" href="tampil-pesanan.php" role="button">Data Pesanan</a>
